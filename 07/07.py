...
# AI in PR: Automating presentation generation using python-pptx
...
# Slide 2: Applications of AI in PR
slide_layout = prs.slide_layouts[1]
slide = prs.slides.add_slide(slide_layout)
slide.shapes.title.text = "Applications of AI in PR"
tf = slide.placeholders[1].text_frame; tf.text = "Media Monitoring"
for point in ["Chatbots", "Sentiment Analysis", "Content Generation"]:
    p = tf.add_paragraph(); p.text = point

# Slide 3: Brand Logo / Image Branding
...
Location: output/final_presentation.pptx
"""
