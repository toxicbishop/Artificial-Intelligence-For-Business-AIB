...
# Display Predictions 
predicted_df = pd.DataFrame({"Day": future_days.flatten(), "Predicted Sessions": 
predicted_sessions}) 
...
sns.lineplot(x=predicted_df["Day"], y=predicted_df["Predicted Sessions"], label="PredictedData", linestyle="dashed") 
